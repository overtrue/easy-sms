...
use Overtrue\EasySms\Gateways\MasecloudGateway;
use Overtrue\EasySms\Message;
use Overtrue\EasySms\PhoneNumber;
use Overtrue\EasySms\Support\Config;
use Overtrue\EasySms\Tests\TestCase;

class MasecloudGatewayTest extends TestCase
{
    public function testSend()
    {
        ...
        $gateway = \Mockery::mock(MasecloudGateway::class.'[get]', [$config])->shouldAllowMockingProtectedMethods();
        ...
        $gateway->shouldReceive('post')
            ->with(MasecloudGateway::ENDPOINT_URL, \Mockery::on(function ($params) use ($expected) {
