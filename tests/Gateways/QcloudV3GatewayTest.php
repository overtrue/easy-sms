...
use Overtrue\EasySms\Gateways\QcloudV3Gateway;
use Overtrue\EasySms\Message;
use Overtrue\EasySms\PhoneNumber;
use Overtrue\EasySms\Support\Config;
use Overtrue\EasySms\Tests\TestCase;

class QcloudV3GatewayTest extends TestCase
{
    public function testSend()
    {
        ...
        $gateway = \Mockery::mock(QcloudV3Gateway::class.'[request]', [$config])->shouldAllowMockingProtectedMethods();
